...
const Admin = props => {
    ...
    const H5Elem = module.enhanceCom("div");
    ...
    return html`
        ...
        paper: `${classes.drawerPaper} ${module.state.drawerOpen ? '' : classes.drawerPaperClose} `
                ...
                <main className=${ classes.content }>
                    ...
                    <${H5Elem} key="agkhudx3" style=${{"width":"129.062px","height":"28px","position":"absolute","left":"434px","top":"253px","transform":"matrix(0.889147, 0.457621, -0.457621, 0.889147, 0, 0)"}} x_id="xid_j4wvnoy4" usemodule_tag="button">
                        button
                    </${H5Elem}>
                </main>
            </div>
